...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/feedback', icon: Star, label: 'Feedback Avancado' },
      { href: '/admin/destinations', icon: MapPin, label: 'Destinos Populares' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/geo-zones', icon: MapPin, label: 'Zonas Geograficas' },
      ...
      { href: '/admin/terms', icon: FileText, label: 'Versoes Termos' },
